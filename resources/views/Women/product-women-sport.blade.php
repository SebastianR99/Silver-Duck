...
<html lang="en">
 ...
 <!-- SCROLL TOP BUTTON -->
  ...
  <section id="aa-catg-head-banner">
   <img src="{{ url('/assets/img/fashion/fashion-header-bg-women-sport.jpg') }}" alt="fashion img">
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul>
                  ...
                  <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ $arrayProducts[8]->product_pic1 }}"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#"> {{ $arrayProducts[8]->product_name }} </a></h4>
                        <p> ${{ $arrayProducts[8]->product_price }} </p>
                    </div>                    
                  </li>                                  
                </ul>
              </div>                            
