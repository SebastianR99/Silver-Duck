          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul>
                  ...
                  <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ $arrayProducts[0]->product_pic1 }}"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#"> {{ $arrayProducts[0]->product_name }} </a></h4>
                        <p> ${{  $arrayProducts[0]->product_price }} </p>
                    </div>                    
                  </li>     
                  <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ $arrayProducts[1]->product_pic1 }}"></a>
